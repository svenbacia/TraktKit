...
//    return buildResource(base: , path: basePath, params: parameters(extended: extended))
//  }
//
//  public func comments(_ extended: Extended? = nil, page: Int? = nil, limit: Int? = nil) -> Resource<Any> {
//    return buildResource(path: basePath + "/comments", params: parameters(page: page, limit: limit, extended: extended))
//  }
//
